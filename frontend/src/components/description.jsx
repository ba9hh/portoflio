...
const Description = () => {
  ...
  return (
    <div className="w-full border-white bg-white dark:bg-gray-800 md:pt-10 pb-7 flex justify-center md:px-10">
      <div className="flex flex-col md:flex-row items-center justify-around gap-5 border rounded-md md:px-5 py-2 border-white md:bg-gray-200 dark:bg-gray-700">
        <div className="md:hidden md:w-1/2 flex justify-center border">
          <img
            src={me}
            className="w-1/2 rounded-full aspect-square object-cover p-10"
          />
        </div>
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center gap-2 border">
